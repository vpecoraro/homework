...
- Images that are smaller than the width of the content box should center. (not sure)
- The paragraphs are all slurred together. There should be 20px of space between them. (not sure)
